---
title: "Annotation of Crosslee's Seurat objects"
...
Seurat_obj@meta.data <- Seurat_obj@meta.data %>% 
  mutate(Slide_num = str_extract(Run_Tissue_name, "(?<=Slide)\\d+"), 
         # Slide = paste0("Slide_", slide_ID_numeric), ## Contained here i didnt have to use the regex ##
